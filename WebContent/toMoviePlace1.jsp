...
<button onclick="document.getElementById('modal-wrapper2').style.display='block'" style="width:60px;position:absolute; top:145px; right:125px;">Delete</button>
    ...
    <form class="modal-content animate" action="AddEntityMoviePlace" method="post">
    ...
    <form class="modal-content animate" action="UpdateEntityMoviePlace" method="post">
        <div class="imgcontainer">
    ...
    <form class="modal-content animate" action="DeleteEntityMoviePlace" method="post">
        <div class="imgcontainer">
